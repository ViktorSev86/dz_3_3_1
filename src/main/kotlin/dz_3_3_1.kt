fun main() {
    ...
    //service.createMessage(12, 1, "A.")
    //service.createMessage(1, 3, "Здорово")
    //service.createMessage(3, 1, "Привет")
    //service.createMessage(11, 12, "Добрый день.")
    //println(service.getAllChatsUser(1))
    //println(service.getAllChatsUser(11))
    //service.deleteMessage(1, 1)
    //service.deleteMessage(3, 1)
    //println(service.getAllChatsUser(1))
    //println(service.getAllChatsUser(11))
    //println(service.getAllLastMessagesUser(1))
